...
@section('content')
    <div class="mb-8">
        ...
        <p class="text-gray-600 mt-1">Add income or expense to your account</p>
    </div>
            ...
            <form action="{{ route('transactions.store') }}" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <select name="payment_method" id="payment_method"
                        ...
                        <option value="debit_card" @if(old('payment_method') === 'debit_card') selected @endif>Debit Card</option>
                        <option value="bank_transfer" @if(old('payment_method') === 'bank_transfer') selected @endif>Bank Transfer</option>
                        <option value="e_wallet" @if(old('payment_method') === 'e_wallet') selected @endif>E-Wallet</option>
